...
export function TrendingMovies({
	...
	if (!movie) {
		return <ErrorComponent error={"Movie is not valid"}></ErrorComponent>;
	}

	return (
		<li className="min-w-[140px] md:min-w-[180px] flex flex-row items-center">
						...
						<motion.div
							...
							style={{
								backgroundImage: `url(https://image.tmdb.org/t/p/w500/${
									movie.poster_path || "no-poster.png"
								})`,
							}}
